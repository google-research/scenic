...
--config=third_party/py/scenic/projects/baselines/configs/imagenet/imagenet_resnet_config.py \
--platform=jf_8x8 --cell=tp \
--xm_resource_alloc=group:brain/scenic \
--exp_name=imagenet_resnet
# END GOOGLE-INTERNAL
"""

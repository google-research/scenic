...
Find the relavant config here:
https://colab.corp.google.com/drive/1UkDcxJrgxZ4iZeP4_gweEE7wjF2iJQoq#scrollTo=EoWJwPvlpCnn

gxm third_party/py/scenic/google/xm/launch_xm.py -- \
--config=third_party/py/scenic/projects/baselines/configs/imagenet/imagenet_reg_vit_config.py \
--platform=jf_8x8 --cell=tp \
--exp_name=ImageNet-RegViT-B/16
# END GOOGLE-INTERNAL
"""
# pylint: disable=line-too-long

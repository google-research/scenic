...
"""Vision Transformer with topological attention."""
...
from scenic.model_lib.layers import top_attention as ta
import scipy
...
class Encoder(nn.Module):
  ...
  def __call__(self, inputs: jnp.ndarray, *, train: bool = False):
    ...
    # !Put something in here controlling the masking in each layer!
...
class TopologicalViT(nn.Module):
  """Topological Vision Transformer model.
    ...
    kernel_type: type of the attention kernel used. Currently the model supports
      two kernels: 'relu' and 'softmax'.
  """
...
class TopViTMultiLabelClassificationModel(MultiLabelClassificationModel):
  ...
  def build_flax_model(self)-> nn.Module:
    ...
    return TopologicalViT(
        ...
        kernel_type='softmax'   #  change the kernel type here
    )
  ...
  def init_from_train_state(
    ...
    Returns:
      Updated train_state.
    """
    return init_topvit_from_train_state(

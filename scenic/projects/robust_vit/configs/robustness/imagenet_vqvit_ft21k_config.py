...
r"""Configs for finetuning the given pretrained model on ImageNet1K. The ImageNet21K pretrained model is a Regularized ViT that uses VQGAN based discrete representation (using imagenet21k_vqvit_augreg_config.py). VQGAN is trained on ImageNet21K.

...
UCF101_TRAIN_SIZE = 9437
UCF101_VAL_SIZE = 3797
UCF101_TEST_SIZE = 3797
...
def get_config(runlocal=''):
  ...
  config.experiment_name = 'vivit_ucf101_classification-vit'
  # Dataset.
  ...
  config.dataset_configs.base_dir = (
      "/users/undergraduate/rjchen25/UCF101/UCF101_proc_datasets")
  config.dataset_configs.tables = {
      'train': 'ucf101_train01@97',
      'validation': 'ucf101_test01@61',
      'test': 'ucf101_test01@61'
  }
  ...
  config.dataset_configs.num_classes = 101
  config.data_dtype_str = 'float32'
  ...
  #config.model.quant = True
  #config.model.quant_type = "PTQ"
  ...
  config.init_from.checkpoint_path = '/user/undergraduate/rjchen25/scenic/scenic/projects/vivit/checkpoints/test1/'
